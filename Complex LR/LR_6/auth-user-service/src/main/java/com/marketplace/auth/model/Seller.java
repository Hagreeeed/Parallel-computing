...
public class Seller {
    ...
    public Seller(User user, String shopName, String description, Double commissionRate) {
        this.user = user; this.shopName = shopName; this.description = description;
        this.rating = 0.0; this.totalSales = 0; this.commissionRate = commissionRate; this.verified = false;
    }
